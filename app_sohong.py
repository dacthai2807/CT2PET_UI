...
gcn_qsdd_tsgl_ms_table_1 = INFO_EXTRACT(weight_path ='./weights/layout_v2_final_gcn_qsdd_tsgl_ms_table_1_2023-01-22.pth', template='gcn_qsdd_tsgl_ms', device=device_2)
gcn_qsdd_tsgl_ms_table_3 = INFO_EXTRACT(weight_path ='./weights/layout_v2_final_gcn_qsdd_tsgl_ms_table_3_2023-06-01.pth', template='gcn_qsdd_tsgl_ms', device=device_2)
gcn_qsdd_tsgl_mt = INFO_EXTRACT(weight_path ='./weights/layout_v2_final_gcn_qsdd_tsgl_mt_2023-02-07.pth', template='gcn_qsdd_tsgl_mt', device=device_1)
